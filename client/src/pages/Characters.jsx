// Characters.jsx: Fetches and displays a grid of all characters from the API
...
function Characters() {
    ...
    useEffect(() => {
        // Redirect to login if token is missing (unauthenticated)
    ...
    // Handles logout and removes user data from localStorage
    const handleLogout = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6">
            <div className="max-w-6xl mx-auto">
                {/* Header: Favourites link, title, profile icon with dropdown */}
